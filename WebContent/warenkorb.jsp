	...
	<div class="header">
		...
		<div class="best-sellers">
			...
			<div class="best-sellers-menu">
				<ul>
					<li><a class="active" href="index.jsp">Elektronik</a></li>
					<li><a href="#">Mode</a></li>
...
<p>
	...
	<br/>oder<br/><br/>
	<form action="bezahlen.jsp" method="post">
		Name: <input name="name"><br> Adresse: <input
			name="adresse"><br> Kreditkartennummer: <input
			name="kartennr"><br> CVC-Code: <input name="cvc"><br>
		E-Mail: <input name="email"><br> <input type="submit"
			value="bezahlen">
	</form>
