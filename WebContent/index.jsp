...
<body>
	...
	<%
		try {
			...
			PreparedStatement ps = conn.prepareStatement("select * from waren");
			...
			<ul id="flexiselDemo">
				...
				<li>
					<div class="ipad text-center">
						<img src="images/<%=rs.getString("img")%>" alt="" />
						<h4>
						...
						<br /> Prozessor:
						<%=rs.getString("prozessor")%>
						<br /> Speicherkapazität:
						<%=rs.getString("speicherkapazität")%>
						<br /> Displaydiagonale:
						<%=rs.getString("displaydiagonale")%>
						<br /> Farbe:
						<%=rs.getString("farbe")%>
						<br /> Batterie:
						<%=rs.getString("batterie")%>
						<br /> Gewicht:
						<%=rs.getString("gewicht")%>
						<br />
						<br />
						<ul>
							<form action="order.jsp" method="post">
								<input type="hidden" name="product"
									value="<%=rs.getString("bezeichnung")%>"> <input
									type="hidden" name="count" type="number" value=1> <input
									type="submit" value="in den Warenkorb">
							</form>
							<br/>
						</ul>
						<div class="clearfix"></div>
						<ul>
							...
							<li><a class="cart" href="">Zur Wunschliste hinzufügen</a></li>
						</ul>
					</div>
				</li>
